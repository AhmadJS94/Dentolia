...
import LabGeneralInfoTab from '../components/LabItems/SingleLabItems/LabGeneralInfoTab';
import LabHistory from '../components/LabItems/SingleLabItems/LabHistory';
...
export default function SingleLab() {
      ...
      <div className={classes.mainContainer}>
        <div className={classes.patientNameBox}>
          <Typography className={classes.patientName} variant="h2">
            Souheil Haddad <span className={classes.id}>#26658975</span>
          </Typography>
        </div>
